...
breakdown = {
    1: [(1623378600 + 600, 120), (1623378600 + 840, 60)],
    2: [(1623378600 + 1200, 120)],
    3: [(1623378600 + 1800, 120), (1623378600 + 2000, 60)],
    4: [(1623378600 + 2400, 120)],
}
breakdown2 = {1: [], 2: [], 3: [], 4: []}
model_capacity = 500
...
endtime = seconds
initial_model_list = []
initial_model_list.append((1, 44))
initial_model_list.append((2, 44))
initial_model_list.append((3, 44))
...
def print_job_data(data):
    for d in data:
        print(
            "job came {} at =     {}       in machine {}      for product {}   job number = {}".format(
                d[2], d[1], d[3], d[0], d[4]
            )
        )
...
class Model_Factory:
    def __init__(self, env):
        ...
        for i in range(len(initial_model_list)):
            self.model.append(
                simpy.Container(
                    env, capacity=model_capacity, init=initial_model_list[i][1]
                )
            )
        ...
        for j in range(len(initial_model_list)):
            if not j == 0:
                ...
                try:
                    if u <= (breakdown[1][0][0] - model_time_setup[0]):
                        ...
                        print(
                            "breakdown while MILLING SETUP, taking timeout",
                            datetime.datetime.fromtimestamp(
                                int(breakdown[1][0][0])
                            ).strftime("%Y-%m-%d %H:%M:%S"),
                        )
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 1, 1))
                        )
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 2, 1))
                        )
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 2, 2))
                        )
                    ...
                    pass
                switch_data_list.append(
                    tuple((datetime.datetime.fromtimestamp(int(env.now)), 0, 2))
                )
            ...
            for i in range(0, initial_model_list[j][1]):
                ...
                job_data_list.append(
                    tuple(
                        (
                            str(initial_model_list[j][0]),
                            datetime.datetime.fromtimestamp(int(env.now)),
                            "IN",
                            1,
                            job,
                        )
                ...
                if not end_m == 0:
                    switch_data_list.append(
                        tuple((datetime.datetime.fromtimestamp(int(end_m)), 0, 2))
                    )
                else:
                    switch_data_list.append(
                        tuple((datetime.datetime.fromtimestamp(int(starttime)), 0, 2))
                    )
                    switch_data_list.append(
                        tuple((datetime.datetime.fromtimestamp(int(starttime)), 1, 1))
                    )
                switch_data_list.append(
                    tuple(
                        (
                            datetime.datetime.fromtimestamp(
                                int(env.now + loading_time)
                            ),
                            0,
                            2,
                        )
                ...
                try:
                    if u <= (breakdown[1][0][0] - random_time):
                        ...
                        print(
                            "breakdown while MILLING was running, taking timeout",
                            datetime.datetime.fromtimestamp(
                                int(breakdown[1][0][0])
                            ).strftime("%Y-%m-%d %H:%M:%S"),
                        )
                        ...
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 1, 2))
                        )
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 2, 1))
                        )
    ...
    while True:
        for j in range(len(initial_model_list)):
            if not j == 0:
                ...
                try:
                    if u <= (breakdown[2][0][0] - model_time_setup[1]):
                        ...
                        print(
                            "breakdown while SHAPING SETUP, taking timeout",
                            datetime.datetime.fromtimestamp(
                                int(breakdown[2][0][0])
                            ).strftime("%Y-%m-%d %H:%M:%S"),
                        )
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 1, 3))
                        )
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 2, 3))
                        )
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 2, 4))
                        )
                    ...
                    pass
                switch_data_list.append(
                    tuple((datetime.datetime.fromtimestamp(int(env.now)), 0, 4))
                )
            ...
            for i in range(0, initial_model_list[j][1]):
                ...
                if not end_m == 0:
                    switch_data_list.append(
                        tuple((datetime.datetime.fromtimestamp(int(end_m)), 0, 4))
                    )
                else:
                    switch_data_list.append(
                        tuple((datetime.datetime.fromtimestamp(int(starttime)), 0, 4))
                    )
                    switch_data_list.append(
                        tuple((datetime.datetime.fromtimestamp(int(starttime)), 1, 3))
                    )
                switch_data_list.append(
                    tuple(
                        (
                ...
                yield env.timeout(loading_time)
                u = env.now
                product_time = product_cycle[(initial_model_list[j][0] - 1)][
                    2
                ]  # get the mean and deviation
                random_time = int(
                    random.gauss(product_time[0], product_time[1])
                )  # save the random time for the cycle in variable
                try:
                    if u <= (breakdown[2][0][0] - random_time):
                        pass
                    else:
                        print(
                            "breakdown while SHAPING was running, taking timeout",
                            datetime.datetime.fromtimestamp(
                                int(breakdown[2][0][0])
                            ).strftime("%Y-%m-%d %H:%M:%S"),
                        )
                        ...
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 1, 4))
                        )
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 2, 3))
                        )
            ...
            if not j == 0:
                ...
                try:
                    if u <= (breakdown[3][0][0] - model_time_setup[2]):
                        ...
                        print(
                            "breakdown while PLANING SETUP, taking timeout",
                            datetime.datetime.fromtimestamp(
                                int(breakdown[3][0][0])
                            ).strftime("%Y-%m-%d %H:%M:%S"),
                        )
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 1, 6))
                        )
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 2, 6))
                        )
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 2, 7))
                        )
                    ...
                    pass
                switch_data_list.append(
                    tuple((datetime.datetime.fromtimestamp(int(env.now)), 0, 7))
                )
            ...
            for i in range(0, initial_model_list[j][1]):
                ...
                job_data_list.append(
                    tuple(
                        (
                            str(initial_model_list[j][0]),
                            datetime.datetime.fromtimestamp(int(env.now)).strftime(
                                "%Y-%m-%d %H:%M:%S"
                            ),
                            "IN",
                            3,
                ...
                if not end_m == 0:
                    switch_data_list.append(
                        tuple((datetime.datetime.fromtimestamp(int(end_m)), 0, 7))
                    )
                else:
                    switch_data_list.append(
                        tuple((datetime.datetime.fromtimestamp(int(starttime)), 0, 7))
                    )
                    switch_data_list.append(
                        tuple((datetime.datetime.fromtimestamp(int(starttime)), 1, 6))
                    )
                switch_data_list.append(
                    tuple(
                        (
                ...
                try:
                    if u <= (breakdown[3][0][0] - random_time):
                        ...
                        print(
                            "breakdown while PLANING was running, taking timeout",
                            datetime.datetime.fromtimestamp(
                                int(breakdown[3][0][0])
                            ).strftime("%Y-%m-%d %H:%M:%S"),
                        )
                        ...
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 1, 7))
                        )
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 2, 6))
                        )
    ...
    while True:
        for j in range(len(initial_model_list)):
            if not j == 0:
                ...
                try:
                    if u <= (breakdown[4][0][0] - model_time_setup[3]):
                        ...
                        print(
                            "breakdown while HONING SETUP, taking timeout",
                            datetime.datetime.fromtimestamp(
                                int(breakdown[4][0][0])
                            ).strftime("%Y-%m-%d %H:%M:%S"),
                        )
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 1, 8))
                        )
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 2, 8))
                        )
                        switch_data_list.append(
                            tuple((datetime.datetime.fromtimestamp(int(env.now)), 2, 9))
                        )
                    ...
                    pass
                switch_data_list.append(
                    tuple((datetime.datetime.fromtimestamp(int(env.now)), 0, 9))
                )
            ...
            for i in range(0, initial_model_list[j][1]):
                ...
                if not end_m == 0:
                    switch_data_list.append(
                        tuple((datetime.datetime.fromtimestamp(int(end_m)), 0, 9))
                    )
                else:
                    switch_data_list.append(
                        tuple((datetime.datetime.fromtimestamp(int(starttime)), 0, 9))
                    )
                    switch_data_list.append(
                        tuple((datetime.datetime.fromtimestamp(int(starttime)), 1, 8))
                    )
                switch_data_list.append(
                    tuple(
                        (
                ...
                yield env.timeout(loading_time)
                switch_data_list.append(
                    tuple((datetime.datetime.fromtimestamp(int(env.now)), 1, 9))
                )
                u = env.now
                product_time = product_cycle[(initial_model_list[j][0] - 1)][
                    3
                ...
                try:
                    if u <= (breakdown[4][0][0] - random_time):
                        ...
                        print(
                            "breakdown while HONING was running, taking timeout",
                            datetime.datetime.fromtimestamp(
                                int(breakdown[4][0][0])
                            ).strftime("%Y-%m-%d %H:%M:%S"),
                        )
...
def insert_switch_data():
    with psycopg2.connect(CONNECTION) as conn:
        query = (
            """INSERT INTO switch_data (time, status, switch_id) VALUES (%s, %s, %s)"""
        )
        cursor = conn.cursor()
                ...
                if j == breakdown2[1][0][0]:
                    for i in range(breakdown2[1][0][1]):
                        meter_list.append(
                            tuple(
                                (
                                    datetime.datetime.fromtimestamp(int(j + i)),
                                    1,
                ...
                if j == breakdown2[2][0][0]:
                    for i in range(breakdown2[2][0][1]):
                        meter_list.append(
                            tuple(
                                (
                                    datetime.datetime.fromtimestamp(int(i + j)),
                                    3,
...
def insert_meter_data():
    with psycopg2.connect(CONNECTION) as conn:
        query = (
            """INSERT INTO  metre_data (time, metre_id, reading) VALUES (%s, %s, %s)"""
        )
        cursor = conn.cursor()
